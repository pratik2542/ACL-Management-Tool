...
function AuthorizeFullControl() {
  //integration
  const authorizeFullControl = async () => {
    ...
    <div className="main-container">
      <div className="box-container">
        <div className="set-permission-title">
          <span className="permission-title">Authorize Full Control</span>
        </div>
        ...
        <div className="set-permission-button">
          <button onClick={() => authorizeFullControl()}>Authorize</button>
        </div>
      </div>
    </div>
  );
...
export default AuthorizeFullControl;
